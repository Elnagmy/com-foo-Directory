...
<body>
	...
	<div id="Login">
		...
		<p>In order to update your details you have to log in, if you
			don't have your Id and Password please contact your IT administrator</p>
			...
			<table>
				<tbody>
					...
					<tr>
						<td><label> &nbsp; &nbsp;&nbsp;&nbsp; </label></td>
						<% if(login !=null){ %>
						<td><span style="color: red;"> Invalid userId or password </span>
						<%} %>
					</tr>
				</tbody>
			</table>
